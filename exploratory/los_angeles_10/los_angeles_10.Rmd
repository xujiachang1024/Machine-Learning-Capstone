...
LA10.vert_accel.plot <- LA10.vert_accel.plot + scale_colour_manual(values = c("deepskyblue", "black"))
...
LA10.vert_accel_ratio_speed.plot <- LA10.vert_accel_ratio_speed.plot + scale_colour_manual(values = c("black", "deepskyblue"))
...
LA10.sq_vert_accel_ratio_speed.plot <- LA10.sq_vert_accel_ratio_speed.plot + scale_colour_manual(values = c("black", "deepskyblue"))
...
LA10.vert_jolt.plot <- LA10.vert_jolt.plot + scale_colour_manual(values = c("deepskyblue", "black"))
...
LA10.vert_jolt_ratio_speed.plot <- LA10.vert_jolt_ratio_speed.plot + scale_colour_manual(values = c("black", "deepskyblue"))
...
LA10.sq_vert_jolt_ratio_speed.plot <- LA10.sq_vert_jolt_ratio_speed.plot + scale_colour_manual(values = c("black", "deepskyblue"))
...
LA10.vert_jolt_5.plot <- LA10.vert_jolt_5.plot + geom_line(aes(y = vert_jolt_max - vert_jolt_min, colour = "Range (sky blue)"))
