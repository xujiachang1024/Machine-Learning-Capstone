---
title: 'Exploratory Analysis on Los Angeles Road Data (Batch ID: 10)'
...
Note: Speed bumps are labeled as <span style="color:red">red</span> points on the graph.
...
LA10.vert_accel.plot <- LA10.vert_accel.plot + geom_line(aes(y = vert_accel))
...
## Epoch 3: Display of Ratio betwwen Vertical Acceleration (w/o Natural G) and Speed

**vert_accel_ratio_speed**: the ratio betwwen vertical acceleration (without natural gravity) and traveling speed \newline
...
LA10.vert_accel_ratio_speed.plot <- LA10.vert_accel_ratio_speed.plot + geom_line(aes(y = vert_accel_ratio_speed))
...
## Epoch 4: Display of Ratio betwwen Vertical Acceleration (w/o Natural G) and Speed
...
LA10.sq_vert_accel_ratio_speed.plot <- LA10.sq_vert_accel_ratio_speed.plot + geom_line(aes(y = sq_vert_accel_ratio_speed))
...
LA10.vert_jolt.plot <- LA10.vert_jolt.plot + geom_line(aes(y = vert_jolt))
...
## Epoch 6: Display of Ratio betwwen Vertical Jolt and Speed
...
LA10.vert_jolt_ratio_speed.plot <- LA10.vert_jolt_ratio_speed.plot + geom_line(aes(y = vert_jolt_ratio_speed))
...
## Epoch 7: Display of Ratio betwwen Squared Vertical Jolt and Speed
...
LA10.sq_vert_jolt_ratio_speed.plot <- LA10.sq_vert_jolt_ratio_speed.plot + geom_line(aes(y = sq_vert_jolt_ratio_speed))
