...
print('\n-----------------------------------')
print('sklearn.ensemble.ExtraTreeClassifier Model 1')
...
# Calculate cross-validation average
print('\n-----------------------------------')
print('sklearn.ensemble.ExtraTreeClassifier Model 2')
...
# Calculate cross-validation average
print('\n-----------------------------------')
print('sklearn.ensemble.ExtraTreeClassifier Model 3')
...
# Calculate cross-validation average
print('\n-----------------------------------')
print('sklearn.ensemble.ExtraTreeClassifier Model 4')
