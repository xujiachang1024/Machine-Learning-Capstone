...
clf = RandomForestClassifier(random_state=0)  # create a MLPClassifier
...
print('\n-----------------------------------')
print('sklearn_Models.ensemble.RandomForestClassifier Model 1')
...
# Calculate cross-validation average
print('\n-----------------------------------')
print('sklearn_Models.ensemble.RandomForestClassifier Model 2')
...
# Calculate cross-validation average
print('\n-----------------------------------')
print('sklearn_Models.ensemble.RandomForestClassifier Model 3')
...
# Calculate cross-validation average
print('\n-----------------------------------')
print('sklearn_Models.ensemble.RandomForestClassifier Model 4')
