...
print('\n-----------------------------------')
print('sklearn.neural_network.MLPClassifier Model 1')
...
#
# # Prepare for cross-validation
# clf = MLPClassifier(solver='lbfgs', alpha=0.0001, hidden_layer_sizes=(4, 2), random_state=0)  # create a MLPClassifier
# f1_scores = []  # sum of F1 scores
# cv = 100  # number of cross-validations
#
#
...
# # Calculate cross-validation average
# print('\n-----------------------------------')
# print('sklearn.neural_network.MLPClassifier Model 2')
...
# # MLP Neural Network Model 5
# # Separate Y and X variables
# df_label = df.loc[:, 'speedbump']
# df_feature = df.loc[:, ('Z', 'z_jolt')]
# Y = df_label.as_matrix()
# X = df_feature.as_matrix()
#
#
# # Prepare for cross-validation
# clf = MLPClassifier(solver='lbfgs', alpha=0.0001, hidden_layer_sizes=(2, 2), random_state=0)  # create a MLPClassifier
# f1_scores = []  # sum of F1 scores
# cv = 100  # number of cross-validations
#
#
...
# # Calculate cross-validation average
# print('\n-----------------------------------')
# print('sklearn.neural_network.MLPClassifier Model 5')
